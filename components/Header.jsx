...
const Header = () => {
  ...
  return (
    <header className='cusgrid h-24 relative z-10'>
      ...
      <nav>
        <ul className='flex justify-evenly items-center h-full text-lg sm:text-3xl'>
            <li><Link className href='/'>Home</Link></li>
            <li><Link className href='/events'>Event</Link></li>
            <li><Link className href='/register'>Register</Link></li>
        </ul>
      </nav>
