    ...
    <header className='cusgrid h-16 sm:h-24 relative z-10'>
      ...
      <nav>
        <ul className='flex justify-evenly items-center h-full text-md sm:text-3xl'>
            ...
            <li><Link className='text-white bg-black rounded-md bg-opacity-75 p-1 sm:p-2 lg:hover:text-black lg:hover:bg-white lg:hover:bg-opacity-75' href='/register'>Register</Link></li>
        </ul>
      </nav>
