...
const MainPageList = () => {
  const currentStatus = 'UPCOMING';
return (
<>
<section className="relative w-full flex justify-evenly items-center flex-wrap gap-20 md:gap-0 min-h-[24rem]">
  <Link href={{ pathname: `/events/${currentStatus}`, query: { filter: 'outdoor sports' }}} className="md:w-1/3 flex justify-center items-center h-full relative z-10 group">
  ...
  <Link href={{ pathname: `/events/${currentStatus}`, query: { filter: 'indoor sports' }}} className="md:w-1/3 flex justify-center items-center h-full relative z-10 group">
  ...
  <Link href={{ pathname: `/events/${currentStatus}`, query: { filter: 'e-sports' }}} className="md:w-1/3 flex justify-center items-center h-full relative z-10 group">
