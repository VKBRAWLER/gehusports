...
function RegistrationForm({params}) {
    ...
    return (
        <>
        <div className='top-0 bottom-0 left-0 right-0 fixed z-0 flex justify-center items-center'><video className='max-w-none min-h-screen' src={bgsport} autoPlay muted loop/></div>
        ...
        <form id='form-box' className="bg-yellow-200 py-10 rounded-2xl mx-5 w-[calc(100%-2.5rem)] bg-opacity-30 max-w-3xl" onSubmit={handleSubmit}>
            ...
            <div className='flex flex-wrap justify-center items-center mb-5 sm:justify-start sm:m-10'>
                ...
                <div className='w-full m-2 flex justify-center'>
                    ...
                    :<span onClick={()=>{document.getElementById('screenshot').click()}} className="cursor-pointer form-box px-4 py-1 rounded text-white border-2 border-white bg-yellow-300">Click Here To Upload</span>}
                </div>
            </div>
