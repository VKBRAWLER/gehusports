  ...
  return (
    ...
    {/* <div className='absolute top-0 w-full h-screen flex justify-center items-center overflow-hidden'><video className='z-0 max-w-none w-auto h-full' src={valo} autoPlay muted loop/></div> */}
      ...
      <section className="my-10 w-full flex justify-evenly items-center min-h-[600px] flex-wrap">
        <div className="boss relative order-n group overflow-hidden"><p className='absolute -bottom-28 p-2 group-hover:bottom-14 duration-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi a aliquid explicabo eaque? Vero dignissimos officia nulla laudantium id nesciunt laboriosam facere adipisci amet. Ducimus, deleniti. Ea provident perspiciatis earum.</p><img src={facimg} alt="" className="lg:w-full h-full max-w-full" /><h4 className='w-full text-center bottom-3 absolute text-3xl font-semibold bg-white'>Dr. M. C. Lohani</h4></div>
