...
const HomePage = () => {
  ...
  return (
    <main>
    <div className='absolute top-0 w-full h-screen flex justify-center items-center overflow-hidden'><video className='z-0 max-w-none w-auto h-full' src="/videos/Valorant.mp4" autoPlay muted loop/></div>
